...
import com.zcq.hostmodeble.ble.callback.BleScanAndConnectCallback;
import com.zcq.hostmodeble.ble.callback.BleScanCallback;
import com.zcq.hostmodeble.ble.callback.BleWriteCallback;
import com.zcq.hostmodeble.ble.entity.BleDevice;
import com.zcq.hostmodeble.ble.entity.BleScanState;
import com.zcq.hostmodeble.ble.exception.OtherException;
import com.zcq.hostmodeble.ble.scan.BleScanRuleConfig;
import com.zcq.hostmodeble.ble.scan.BleScanner;
...
/**
 * Create by zcq on 7/8/22 10:17 AM
 */
...
public class BleHelper {
    ...
    public static BleHelper getInstance(){
        return BleHolder.mBleHelper;
    }

    private static class BleHolder {
        private static final BleHelper mBleHelper = new BleHelper();
    }
     ...
     * @return BleManager
     */
    public BleHelper setMaxConnectCount(int count) {
     ...
     * @return BleManager
     */
    public BleHelper setOperateTimeout(int count) {
     ...
     * @return BleManager
     */
    public BleHelper setReConnectCount(int count) {
     ...
     * @return BleManager
     */
    public BleHelper setReConnectCount(int count, long interval) {
        if (count > 10)
            count = 10;
        if (interval < 0)
            interval = 0;
     ...
     * @return BleManager
     */
    public BleHelper setSplitWriteNum(int num) {
        if (num > 0) {
     ...
     * @return BleManager
     */
    public BleHelper setConnectOverTime(long time) {
        if (time <= 0) {
            time = 100;
        }
     ...
     * @return BleManager
     */
    public BleHelper enableLog(boolean enable) {
