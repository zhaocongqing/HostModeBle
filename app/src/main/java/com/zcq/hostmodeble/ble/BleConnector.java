...
import com.zcq.hostmodeble.ble.entity.BleWriteState;
import com.zcq.hostmodeble.ble.exception.GattException;
...
public class BleConnector {
    ...
    //连接特征属性值uuid
    private static final String UUID_CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR = "00005841-0000-1000-8000-00805F9B34FB";
    ...
    private void handleCharacteristicNotifyCallback(BleNotifyCallback bleNotifyCallback,
        ...
        if (bleNotifyCallback != null) {
            ...
            mHandler.sendMessageDelayed(
                    ...
                    BleHelper.getInstance().getOperateTimeout());
        }
    }
