package com.zcq.hostmodeble.ble;
...
import com.zcq.hostmodeble.ble.callback.BleGattCallback;
import com.zcq.hostmodeble.ble.callback.BleIndicateCallback;
import com.zcq.hostmodeble.ble.callback.BleMtuChangedCallback;
import com.zcq.hostmodeble.ble.callback.BleNotifyCallback;
import com.zcq.hostmodeble.ble.callback.BleReadCallback;
import com.zcq.hostmodeble.ble.callback.BleRssiCallback;
import com.zcq.hostmodeble.ble.callback.BleWriteCallback;
import com.zcq.hostmodeble.ble.entity.BleConnectStateParameter;
import com.zcq.hostmodeble.ble.entity.BleDevice;
import com.zcq.hostmodeble.ble.entity.BleMsg;
import com.zcq.hostmodeble.ble.exception.ConnectException;
import com.zcq.hostmodeble.ble.exception.OtherException;
import com.zcq.hostmodeble.ble.exception.TimeoutException;
import com.zcq.hostmodeble.ble.utils.BleLog;
...
/**
 * Create by zcq on 7/8/22 11:54 AM
 */
...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            bluetoothGatt = bleDevice.getDevice().connectGatt(BleHelper.getInstance().getContext(),
        ...
        if (bluetoothGatt != null) {
            ...
            mainHandler.sendMessageDelayed(message, BleHelper.getInstance().getConnectOverTime());
            ...
            BleHelper.getInstance().getMultipleBluetoothController().removeConnectingBle(BleBluetooth.this);
            if (bleGattCallback != null)
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case BleMsg.MSG_CONNECT_FAIL: {
                    ...
                    if (connectRetryCount < BleHelper.getInstance().getReConnectCount()) {
                        BleLog.e("Connect fail, try reconnect " + BleHelper.getInstance().getReConnectInterval() + " millisecond later");
                        ++connectRetryCount;

                        Message message = mainHandler.obtainMessage();
                        message.what = BleMsg.MSG_RECONNECT;
                        mainHandler.sendMessageDelayed(message, BleHelper.getInstance().getReConnectInterval());
                    } else {
                        lastState = LastState.CONNECT_FAILURE;
                        BleHelper.getInstance().getMultipleBluetoothController().removeConnectingBle(BleBluetooth.this);
                ...
                case BleMsg.MSG_DISCONNECTED: {
                    ...
                    BleHelper.getInstance().getMultipleBluetoothController().removeBleBluetooth(BleBluetooth.this);
                ...
                case BleMsg.MSG_DISCOVER_SUCCESS: {
                    ...
                    BleHelper.getInstance().getMultipleBluetoothController().removeConnectingBle(BleBluetooth.this);
                    BleHelper.getInstance().getMultipleBluetoothController().addBleBluetooth(BleBluetooth.this);
